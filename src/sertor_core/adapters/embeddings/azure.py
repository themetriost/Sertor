...
Supporta due superfici Azure: la "v1" (endpoint `.../openai/v1`, senza `api-version`) e quella
classica (con `?api-version=`). `api-version` è inviato solo se l'endpoint NON è v1.
"""
