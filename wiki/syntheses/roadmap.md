...
### 🔄 In progress
**🔴 P0 MISURATO — E15-FEAT-012: testiamo l'installazione, spediamo aggiornamenti** · *dove:* riga di backlog in `requirements/fedelta-dogfood/epic.md` · *prossimo passo:* **`requirements`** · *decisione aperta:* se farne il prossimo lavoro al posto dei singoli bug.
