...
| Distribuzione multi-assistente: GitHub Copilot (+ Codex Could) | — | 📋 **decomposta (2026-06-15)** — requisiti pronti ([`distribuzione-copilot/requirements.md`](../../requirements/sertor-cli/distribuzione-copilot/requirements.md), 22 REQ, parità piena su wiki+rag); prossimo: `/speckit-specify` |
