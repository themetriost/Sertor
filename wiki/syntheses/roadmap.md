...
| 🆕 [`debito-tecnico`](../../requirements/debito-tecnico/epic.md) | 🔄 in progress | CI Linux (Should) — *unif. venv ✅ · host-agnosticità asset **FEAT-001 ✅** (parità Copilot wiki NATIVE, merged PR #80) · **FEAT-009 🔄** distribuzione costituzione-starter (lo starter perdeva contro il placeholder spec-kit → replace-if-placeholder + rifinitura principi; branch `058`, PR in apertura) (2026-06-19)* |
