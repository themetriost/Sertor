...
### 🔄 In progress
**✅ CONSEGNATA — E10-FEAT-045: il gate `wiki-guard` non è più insoddisfacibile** (merge `4bfd090`/PR #239). L'ancora della rilevazione del lavoro non registrato è **derivata dalla storia**, non più stimata dagli orologi dei file.
