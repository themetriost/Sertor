...
### 🔄 In progress
Niente attivo. **Rilasciata v0.3.0** «governance» (merge `3b5dd6d`/PR #231): ratificato il **Principio XIV — «Derived State, Not Declared»** (costituzione dogfood **v1.6.0**, starter neutro **0.5.0**) e — per la prima volta — **gli emendamenti raggiungono gli ospiti che una costituzione ce l'hanno già**.
