...
| 🆕 [`debito-tecnico`](../../requirements/debito-tecnico/epic.md) | 🔄 in progress | CI Linux (Should) — *unif. venv ✅ · **host-agnosticità asset (FEAT-001): parità Copilot CLI 🔄 su branch `056`, PR pendente** (2026-06-18)* |
