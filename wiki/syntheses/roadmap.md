...
- **Audit SWOT + backlog azionabile — 🔄 IN CORSO (2026-07-02).**
  ...
  *Consegnato (su master):* **A-01 → A-17 ✅** — dettaglio nella tabella SWOT sotto. A-11 folded in E6
  ...
  **Finding auto-updater** (PR #170): inerte su **repo privato** (fetch `/VERSION` 404) → macchina validata
  ...
  - **A-18 — 🔄 IN CORSO (2026-07-11), branch `096-doc-utente-mvp`.** E13 Fase 1 Musts (doc utente MVP):
    **nuovo `docs/getting-started.md`** (percorso unico host-agnostico «dal nulla al primo valore»,
    ...
    installer **invariati**, D↔N); ruff clean, suite non toccata (0 codice). *Prossimo passo concreto:*
    gate pre-merge verde → PR + merge → post-merge (re-lock/re-index/smoke); poi **A-19**.
