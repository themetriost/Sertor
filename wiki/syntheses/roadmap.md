...
| **E10** | 🆕 [`debito-tecnico`](../../requirements/debito-tecnico/epic.md) | 🔄 in progress | **Should aperti:** CI **Windows GitHub Actions ✅ 2026-06-23** (FEAT-003, Linux = prossima fase) · hook freschezza RAG (FEAT-011) · il resto è Could *(**FEAT-013 allineamento config dogfood↔ospite ✅ 2026-06-23** — dogfood su `.sertor/.env`+`.sertor/.index`, resolver host-agnostico · **FEAT-012 governance nel corpus ✅ 2026-06-23** — costituzione+plan-template indicizzati · unif. venv ✅ · host-agnosticità asset **FEAT-001/009/010 ✅** · disciplina MCP-first agli ospiti ✅, 2026-06-19)* |
...
> Nessuna feature attiva su branch (**FEAT-008 cattura Copilot CLI ✅** su `073-cattura-copilot-cli`,
> SpecKit specify→implement completo, 1039 verdi/Constitution 12/12; **FEAT-004 ricerca semantica
> memoria ✅** merged `a63becb`). **Candidato a valore = il miglioramento per-superficie di
> `search_docs`** (sotto).
