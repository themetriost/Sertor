...
| 🆕 [`debito-tecnico`](../../requirements/debito-tecnico/epic.md) | 🔄 in progress | CI Linux (Should) — *unif. venv ✅ · **host-agnosticità asset (FEAT-001): parità Copilot CLI via agent-skills NATIVE — implementata + verificata LIVE su Spike (`/skills` invoca `wiki-author`, legge il playbook co-locato), PR #80 pronta al merge** (2026-06-19)* |
