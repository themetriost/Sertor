...
created: 2026-05-30
updated: 2026-06-04
sources: ["requirements/sertor-core/epic.md", ".specify/memory/constitution.md", "specs/001-nucleo-retrieval/**", "specs/002-rag-baseline/**", "specs/003-wiki-creazione/**", "specs/004-cli-esecuzione/**", "specs/005-wiki-manutenzione/**", "specs/006-wiki-lint-semantico/**", "src/sertor_core/**"]
---
...
- **[[lint-semantico-feat007]]** — Estensione semantica FEAT-007: `semantic_lint()` + `semantic_lint_incremental()` + `apply_fixes()` + `run_semantic_gate()`. Confronta claim wiki vs codice reale (via LLM), rileva obsolescenza/contraddizioni/lacune/sommari stantii; provenienza pagine (generated|curated); applicazione chirurgica fix su generated; gate pre-commit con override tracciato; watermark git-driven. 155 test, Constitution Check 9/9 ✅. Solo wiring hook fisico (configuration-manager) da fare.
