...
> `wiki-playbook.md`; per **come si scrive una pagina** vedi [`../pagina-ben-fatta.md`](../pagina-ben-fatta.md).
...
2. Scrivi un riassunto in `sources/<slug>.md` con frontmatter (`sources:` = path/URL d'origine). Scrivilo
   secondo [`../pagina-ben-fatta.md`](../pagina-ben-fatta.md) — in particolare il **livello di significato**:
