...
| FEAT-003 | **CI Linux nativo** (suite verde su Linux oltre Windows; debito rag-baseline DA-2) | Portabilità reale verificata in CI | **Should** | 🔄 CI Windows GitHub Actions ✅ 2026-06-23 (`.github/workflows/ci.yml` creato, matrix os=windows-latest, ruff extend-exclude prototipo); Linux = prossima fase (aggiunta riga matrix) |
