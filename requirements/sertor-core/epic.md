...
| FEAT-007 | **Skill: mantenere il wiki vivo** (lint strutturale **+ semantico**, rigenera indice, valida link, rileva orfani/contraddizioni/obsolescenza/lacune, distilla artifact→doc, auto-fix assistito) | Tiene il wiki coerente, **vero** e aggiornato (idempotente) | **Should** (prioritizzata) | [decomposta](wiki-manutenzione/requirements.md) — **strutturale ✅** (Gruppi A–G), **semantico da implementare** (Gruppo H) |
