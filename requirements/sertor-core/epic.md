...
| FEAT-007 | **Skill: mantenere il wiki vivo** (spider/lint: rigenera indice, valida link, rileva orfani/contraddizioni, distilla raw→concept) | Tiene il wiki coerente e aggiornato (idempotente) | **Should** | da decomporre — **assorbe da FEAT-003-N (2026-06-10):** N2 distillazione di conversazione intera (REQ-030..033) e N9 lint organizzativo/reorg (metodo già documentato nel playbook; backlog: helper deterministico `move`-con-link in `wiki_tools`) |
