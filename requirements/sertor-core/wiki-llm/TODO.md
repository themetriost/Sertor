...
| N2 | **distillazione** di sessione/conversazione → pagina | REQ-030/031 | ☐ da fare | richiede LLM configurato; input già pre-elaborato. **Nota (2026-06-10):** la distillazione *di step* è già attiva (op `distill` del playbook, rituale punto 2); qui resta la distillazione di *conversazione intera* |
