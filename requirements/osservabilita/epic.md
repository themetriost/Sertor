...
| FEAT-015 | **Visibilità del RAG nella TUI (dimostrabilità)** — mostrare nella TUI **query · operazione MCP · risultato · verdetto hit/miss** per le ricerche recenti; realizza l'**opt-in raw-text (REQ-E9)** per uso LOCALE (default privacy-safe preservato) | Vedere e **dimostrare** *come* funziona il RAG (NON audit/tracciamento) | **Should** | [decomposta](visibilita-rag-tui/requirements.md) **(2026-06-19)** — 6 domande aperte (hit/miss · cosa mostrare · gate · scheda TUI · query MCP · retention) |
