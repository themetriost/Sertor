...
| FEAT-002 | **Installazione selettiva delle capacità del core** (motori RAG + skill wiki) su un repo target | Portare il core su un progetto, a scelta, senza eseguirlo | **Must** | primo taglio ✅ **CONSEGNATO** (PR #22, 2026-06-11): backbone `sertor` + `sertor install wiki` (pacchetto distinto in uv workspace, validato live su ospite reale); restano `install rag` e `install governance` (stub dichiarati) + **tema lingua degli asset** (👍 utente 2026-06-11: asset in italiano fisso anche con `language=en` — da gestire). **`install rag` in decomposizione** (branch `015-sertor-install-rag`, `install-rag/requirements.md`, scope B = scaffold config + bootstrap dipendenze, 2026-06-12) |
