...
| FEAT-004 | **Ricerca semantica opzionale sull'archivio** — embedding dei transcript come corpus/tier del RAG, opt-in (privacy §7) | Memoria episodica *per significato*, non solo per parola | **Should** | ✅ implementata → [`ricerca-semantica/requirements.md`](ricerca-semantica/requirements.md) · specs/072 · [[feat-004-ricerca-semantica-memoria]] · **debito P2:** manopole `SERTOR_MEMORY_SEMANTIC*` template `.env` installer (follow-up FEAT-009) |
